...
-- WITH ct1 AS (
-- 	SELECT 
-- 		CONCAT("Cl1: ", COUNT(OrderID), " orders") AS "Total number of orders" 
-- 	FROM 
-- 		Orders 
-- 	WHERE 
-- 		YEAR(Date) = 2022 AND ClientID = "Cl1"
-- ),
-- ct2 AS (
-- 	SELECT 
-- 		CONCAT("Cl2: ", COUNT(OrderID), " orders") 
-- 	FROM 
-- 		Orders 
-- 	WHERE 
-- 		YEAR(Date) = 2022 AND ClientID = "Cl2"
-- ),
-- ct3 AS (
-- 	SELECT 
-- 		CONCAT("Cl3: ", COUNT(OrderID), " orders") 
-- 	FROM 
-- 		Orders 
-- 	WHERE 
-- 		YEAR(Date) = 2022 AND ClientID = "Cl3"
-- )
-- SELECT 
-- 	*
-- FROM 
...
--     p.sellprice
-- FROM
-- 	activity a left join products p 
-- ON 
-- 	PROPERTIES->>'$.ProductID' = p.productid
-- WHERE 
